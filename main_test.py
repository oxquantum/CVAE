...
from _data_feeder import prepare_data
from _main_test import test_and_plot as test
...
def main():
    ...
    with tf.device(FLAGS.device):
        ...
        with tf.Session(config=tf.ConfigProto(allow_soft_placement=FLAGS.allow_soft_placement, gpu_options=gpu_options)) as sess:
            ...
            dataset = prepare_data.Data_from_HDF5(data_folder, [], fname_test, shape_out=data_shape)  # Data load
